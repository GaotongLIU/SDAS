...
${tool_dir}/SDAS cellAnnotation scimilarity -i $h5ad_file -o $output_dir --model_dir $model_dir --cell_type_file $cell_type_file --input_gene_symbol_key _index --bin_size $binsize --gpu_id 0
